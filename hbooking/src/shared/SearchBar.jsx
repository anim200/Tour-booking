...
const SearchBar = () => {
  ...
  const searchHandler = async()=>{
    ...
    navigate(`/tours/search/getTourBySearh?city=${location}&distance=${distance}&maxGroupSize=${maxGroupSize}`,{state:result.data})
  }
  return  <Col lg='12'>
    <div className="search_bar">
        <Form className="d-flex align-items-center gap-4">
            ...
            <FormGroup className='d-flex gap-3 form_group form_group-fast'>
                ...
                <div>
                    <h6>Distance</h6>
                    <input type='number' placeholder='Distace k/m' ref={distanceRef}></input>
                </div>
            </FormGroup>
